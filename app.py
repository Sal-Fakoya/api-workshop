...
def home():
    st.title("Home")
    st.write("Welcome to the FinClo!")

def dashboard():
    st.title("Dashboard")
    st.write("This is where analytics and user statistics will be displayed.")
    
def manage():
    st.title("Manage")
    st.write("This is where you can manage user accounts, bills, and other data.")
...
# Menu Function
def select_menu():
    menu = ["Home", "Dashboard", "Manage", "About"]
